// Type definitions for Kendo UI Professional v2020.3.1021
...
declare namespace kendo {
    ...
    function observable(data: any): data.ObservableObject;

    function observableHierarchy(array: any[]): data.ObservableArray;
    ...
    function notify(widget: typeof ui.Widget, namespace?: typeof ui): void;

    function notify(widget: typeof ui.Widget, namespace?: typeof mobile.ui): void;

    function notify(widget: typeof ui.Widget, namespace?: typeof dataviz.ui): void;

    function widgetInstance(element: JQuery, suite?: typeof ui): ui.Widget;

    function widgetInstance(element: JQuery, suite?: typeof mobile.ui): ui.Widget;

    function widgetInstance(element: JQuery, suite?: typeof dataviz.ui): ui.Widget;
...
declare namespace kendo.effects {
    ...
    interface Element {
        expand(direction: string): Expand;
        expandHorizontal(): Expand;
        expandVertical(): Expand;
        fade(direction: string): Fade;
        fadeIn(): Fade;
        fadeOut(): Fade;
        flip(axis: string, face: JQuery, back: JQuery): Flip;
        flipHorizontal(face: JQuery, back: JQuery): Flip;
        flipVertical(face: JQuery, back: JQuery): Flip;
        pageturn(axis: string, face: JQuery, back: JQuery): PageTurn;
        pageturnHorizontal(face: JQuery, back: JQuery): PageTurn;
        pageturnVertical(face: JQuery, back: JQuery): PageTurn;
        slideIn(direction: string): SlideIn;
        slideInDown(): SlideIn;
        slideInLeft(): SlideIn;
        slideInRight(): SlideIn;
        slideInUp(): SlideIn;
        tile(direction: string, previous: JQuery): Tile;
        tileDown(previous: JQuery): Tile;
        tileLeft(previous: JQuery): Tile;
        tileRight(previous: JQuery): Tile;
        tileUp(previous: JQuery): Tile;
        transfer(target: JQuery): Transfer;
        zoom(direction: string): Zoom;
        zoomIn(): Zoom;
        zoomOut(): Zoom;
    }
...
declare namespace kendo.data {
    ...
    class Binding extends Observable {
        ...
        start(source: Observable): void;

        stop(source: Observable): void;
    ...
    class TemplateBinding extends Binding {
        constructor(source: Observable, path: string, template: Function);
    ...
    class TreeListDataSource extends DataSource {
        load(model: TreeListModel): JQueryPromise<any>;

        childNodes(model: TreeListModel): TreeListModel[];

        rootNodes(): TreeListModel[];

        parentNode(model: TreeListModel): TreeListModel;

        level(model: TreeListModel): number;

        level(model: any): number;

        add(model: Object): TreeListModel;

        add(model: TreeListModel): TreeListModel;

        at(index: number): TreeListModel;

        cancelChanges(model?: TreeListModel): void;

        get(id: any): TreeListModel;

        getByUid(uid: string): TreeListModel;

        indexOf(value: TreeListModel): number;

        insert(index: number, model: TreeListModel): TreeListModel;

        insert(index: number, model: Object): TreeListModel;

        remove(model: TreeListModel): void;
    }
    ...
    class SchedulerDataSource extends DataSource {
        add(model: Object): SchedulerEvent;

        add(model: SchedulerEvent): SchedulerEvent;

        at(index: number): SchedulerEvent;

        cancelChanges(model?: SchedulerEvent): void;

        get(id: any): SchedulerEvent;

        getByUid(uid: string): SchedulerEvent;

        indexOf(value: SchedulerEvent): number;

        insert(index: number, model: SchedulerEvent): SchedulerEvent;

        insert(index: number, model: Object): SchedulerEvent;

        remove(model: SchedulerEvent): void;

        expand(start: Date, end: Date): SchedulerEvent;
    }

    class GanttDataSource extends DataSource {
        add(model: Object): GanttTask;

        add(model: GanttTask): GanttTask;

        at(index: number): GanttTask;

        cancelChanges(model?: GanttTask): void;

        get(id: any): GanttTask;

        getByUid(uid: string): GanttTask;

        indexOf(value: GanttTask): number;

        insert(index: number, model: Object): GanttTask;

        insert(index: number, model: GanttTask): GanttTask;

        remove(model: GanttTask): void;
    }

    class GanttDependencyDataSource extends DataSource {
        add(model: Object): GanttDependency;

        add(model: GanttDependency): GanttDependency;

        at(index: number): GanttDependency;

        cancelChanges(model?: GanttDependency): void;

        get(id: any): GanttDependency;

        getByUid(uid: string): GanttDependency;

        indexOf(value: GanttDependency): number;

        insert(index: number, model: Object): GanttDependency;

        insert(index: number, model: GanttDependency): GanttDependency;

        remove(model: GanttDependency): void;
    }
    ...
    class DataSource extends Observable {
        ...
        at(index: number): ObservableObject;

        cancelChanges(model?: Model): void;
        ...
        indexOf(value: ObservableObject): number;

        insert(index: number, model: Model): Model;

        insert(index: number, model: Object): Model;
        ...
        remove(model: ObservableObject): void;
    ...
    class Query {
        ...
        range(intex: number, count: number): Query;
        ...
        order(selector: string, dir?: string): Query;

        order(selector: Function, dir?: string): Query;

        filter(filters: DataSourceFilterItem): Query;

        filter(filters: DataSourceFilterItem[]): Query;

        filter(filters: DataSourceFilters): Query;

        group(descriptors: DataSourceGroupItem): Query;
...
declare namespace kendo.ui {
    ...
    function plugin(widget: typeof Widget, register?: typeof ui, prefix?: String): void;

    function plugin(widget: any, register?: typeof ui, prefix?: String): void;

    function plugin(widget: typeof Widget, register?: typeof mobile.ui, prefix?: String): void;

    function plugin(widget: any, register?: typeof mobile.ui, prefix?: String): void;

    function plugin(widget: typeof Widget, register?: typeof dataviz.ui, prefix?: String): void;

    function plugin(widget: any, register?: typeof dataviz.ui, prefix?: String): void;
    ...
    class DropTargetArea extends Widget {
        element: JQuery;
...
declare namespace kendo.ui.filemanager {
    ...
    class FileManagerCommand extends Class {
        static fn: any;
...
declare namespace kendo.ui.filemanager.commands {
    class CreateFolderCommand extends Class {
        init?(options: any): void;

        exec?(): void;
    }

    class RenameCommand extends Class {
        init?(options: any): void;

        exec?(): void;
    }

    class DeleteCommand extends Class {
        init?(options: any): void;
    ...
    class MoveCommand extends Class {
        init?(options: any): void;

        exec?(): void;
    }

    class CopyCommand extends Class {
        init?(options: any): void;

        exec?(): void;
    }

    class SortCommand extends Class {
        init?(options: any): void;

        exec?(): void;
    }

    class SearchCommand extends Class {
        init?(options: any): void;

        exec?(): void;
    }

    class ChangeViewCommand extends Class {
        init?(options: any): void;

        exec?(): void;
    }

    class OpenDialogCommand extends Class {
        init?(options: any): void;

        exec?(): void;
    }

    class TogglePaneCommand extends Class {
        init?(options: any): void;
...
declare namespace kendo.ui {
    ...
    class AutoComplete extends Widget {
        ...
        setDataSource(dataSource: data.DataSource): void;
    ...
    interface AutoCompleteOptions {
        ...
        autoWidth?: boolean;
        dataSource?: any | any | data.DataSource;
        clearButton?: boolean;
    ...
    class ContextMenu extends Widget {
        ...
        append(item: any, referenceItem?: string): ContextMenu;

        append(item: any, referenceItem?: JQuery): ContextMenu;

        close(element: Element): ContextMenu;

        close(element: JQuery): ContextMenu;

        destroy(): void;

        enable(element: string, enable: boolean): ContextMenu;

        enable(element: Element, enable: boolean): ContextMenu;

        enable(element: JQuery, enable: boolean): ContextMenu;

        findByUid(uid: string): JQuery;

        insertAfter(item: any, referenceItem: string): ContextMenu;

        insertAfter(item: any, referenceItem: Element): ContextMenu;

        insertAfter(item: any, referenceItem: JQuery): ContextMenu;

        insertBefore(item: any, referenceItem: string): ContextMenu;

        insertBefore(item: any, referenceItem: Element): ContextMenu;

        insertBefore(item: any, referenceItem: JQuery): ContextMenu;

        open(x: number, y?: number): ContextMenu;

        open(x: Element, y?: number): ContextMenu;

        open(x: JQuery, y?: number): ContextMenu;

        remove(element: string): ContextMenu;

        remove(element: Element): ContextMenu;

        remove(element: JQuery): ContextMenu;
    ...
    interface ContextMenuOptions {
        ...
        dataSource?: any | any | data.HierarchicalDataSource;
        dataTextField?: string;
        dataUrlField?: string;
    ...
    class DropDownTree extends Widget {
        ...
        setDataSource(dataSource: data.HierarchicalDataSource): void;
    ...
    class FileManager extends Widget {
        ...
        setDataSource(dataSource: data.FileManagerDataSource): void;
    ...
    interface FileManagerOptions {
        ...
        resizable?: boolean;
        draggable?: boolean;
        dataSource?: any | any | data.FileManagerDataSource;
        upload?: any;
        uploadUrl?: string;
    ...
    class FilterMenu extends Widget {
    ...
    class Gantt extends Widget {
        ...
        dataSource: data.DataSource;
        dependencies: data.GanttDependencyDataSource;
        ...
        dataItem(row: string): data.GanttTask;

        dataItem(row: Element): data.GanttTask;

        dataItem(row: JQuery): data.GanttTask;
        ...
        removeDependency(dependency: data.GanttDependency): void;

        removeTask(task: string): void;

        removeTask(task: data.GanttTask): void;
        ...
        setDataSource(dataSource: data.GanttDataSource): void;

        setDependenciesDataSource(dataSource: data.GanttDependencyDataSource): void;
    ...
    interface GanttOptions {
        ...
        dataSource?: any | any | data.GanttDataSource;
        date?: Date;
        dependencies?: any | any | data.GanttDependencyDataSource;
    ...
    interface GanttAddEvent extends GanttEvent {
        task?: data.GanttTask;
        dependency?: data.GanttDependency;
    }
    ...
    class Grid extends Widget {
        ...
        dataItem(row: string): data.ObservableObject;

        dataItem(row: Element): data.ObservableObject;

        dataItem(row: JQuery): data.ObservableObject;

        dataItems(): data.ObservableArray;
    ...
    interface GridColumnFilterableCell {
        dataSource?: any | data.DataSource;
        dataTextField?: string;
        delay?: number;
        inputWidth?: number;
    ...
    interface GridColumn {
        dataTextField?: string;
        dataValueField?: string;
        dataSource?: data.DataSource | data.DataSourceOptions;
        aggregates?: any;
        attributes?: any;
        columns?: any;
    ...
    class ListBox extends Widget {
        ...
        dataItem(element: JQuery): data.ObservableObject;

        dataItem(element: Element): data.ObservableObject;

        dataItem(element: string): data.ObservableObject;
    ...
    class MaskedTextBox extends Widget {
    ...
    class Menu extends Widget {
        ...
        append(item: any, referenceItem?: string): Menu;

        append(item: any, referenceItem?: JQuery): Menu;

        close(element: string): Menu;

        close(element: Element): Menu;

        close(element: JQuery): Menu;

        destroy(): void;

        enable(element: string, enable: boolean): Menu;

        enable(element: Element, enable: boolean): Menu;

        enable(element: JQuery, enable: boolean): Menu;

        findByUid(uid: string): JQuery;

        insertAfter(item: any, referenceItem: string): Menu;

        insertAfter(item: any, referenceItem: Element): Menu;

        insertAfter(item: any, referenceItem: JQuery): Menu;

        insertBefore(item: any, referenceItem: string): Menu;

        insertBefore(item: any, referenceItem: Element): Menu;

        insertBefore(item: any, referenceItem: JQuery): Menu;

        open(element: string): Menu;

        open(element: Element): Menu;

        open(element: JQuery): Menu;

        remove(element: string): Menu;

        remove(element: Element): Menu;

        remove(element: JQuery): Menu;
    ...
    class MultiColumnComboBox extends Widget {
    ...
    class MultiViewCalendar extends Widget {
    ...
    class PanelBar extends Widget {
        ...
        append(item: string, referenceItem?: string): PanelBar;

        append(item: string, referenceItem?: Element): PanelBar;

        append(item: string, referenceItem?: JQuery): PanelBar;

        append(item: Element, referenceItem?: string): PanelBar;

        append(item: Element, referenceItem?: Element): PanelBar;

        append(item: Element, referenceItem?: JQuery): PanelBar;

        append(item: JQuery, referenceItem?: string): PanelBar;

        append(item: JQuery, referenceItem?: Element): PanelBar;

        append(item: JQuery, referenceItem?: JQuery): PanelBar;

        append(item: any, referenceItem?: string): PanelBar;

        append(item: any, referenceItem?: Element): PanelBar;

        append(item: any, referenceItem?: JQuery): PanelBar;

        clearSelection(): void;

        collapse(element: string, useAnimation: boolean): PanelBar;

        collapse(element: Element, useAnimation: boolean): PanelBar;

        collapse(element: JQuery, useAnimation: boolean): PanelBar;

        dataItem(node: JQuery): data.Node;

        dataItem(node: Element): data.Node;

        dataItem(node: string): data.Node;
        ...
        expand(element: string, useAnimation: boolean): PanelBar;

        expand(element: Element, useAnimation: boolean): PanelBar;

        expand(element: JQuery, useAnimation: boolean): PanelBar;
        ...
        insertBefore(item: string, referenceItem: string): PanelBar;

        insertBefore(item: string, referenceItem: Element): PanelBar;

        insertBefore(item: string, referenceItem: JQuery): PanelBar;

        insertBefore(item: Element, referenceItem: string): PanelBar;

        insertBefore(item: Element, referenceItem: Element): PanelBar;

        insertBefore(item: Element, referenceItem: JQuery): PanelBar;

        insertBefore(item: JQuery, referenceItem: string): PanelBar;

        insertBefore(item: JQuery, referenceItem: Element): PanelBar;

        insertBefore(item: JQuery, referenceItem: JQuery): PanelBar;

        insertBefore(item: any, referenceItem: string): PanelBar;

        insertBefore(item: any, referenceItem: Element): PanelBar;

        insertBefore(item: any, referenceItem: JQuery): PanelBar;
    ...
    class PivotConfigurator extends Widget {
        ...
        setDataSource(dataSource: data.PivotDataSource): void;
    ...
    interface PivotConfiguratorOptions {
        name?: string;
        dataSource?: any | data.PivotDataSource;
        filterable?: boolean;
    ...
    class ResponsivePanel extends Widget {
    ...
    class Scheduler extends Widget {
        ...
        editEvent(event: data.SchedulerEvent): void;

        items(): any;

        occurrenceByUid(uid: string): data.SchedulerEvent;
        ...
        removeEvent(event: data.SchedulerEvent): void;
        ...
        setDataSource(dataSource: data.SchedulerDataSource): void;
    ...
    interface SchedulerOptions {
        ...
        dataSource?: any | any | data.SchedulerDataSource;
        date?: Date;
        dateHeaderTemplate?: string | Function;
    ...
    interface ScrollViewOptions {
        ...
        dataSource?: data.DataSource | any;
        duration?: number;
    ...
    class Spreadsheet extends Widget {
        ...
        activeSheet(): spreadsheet.Sheet;

        activeSheet(sheet?: spreadsheet.Sheet): void;

        cellContextMenu(): ContextMenu;

        rowHeaderContextMenu(): ContextMenu;

        colHeaderContextMenu(): ContextMenu;
        ...
        sheetByName(name: string): spreadsheet.Sheet;

        sheetIndex(sheet: spreadsheet.Sheet): number;

        sheetByIndex(index: number): spreadsheet.Sheet;

        insertSheet(options: any): spreadsheet.Sheet;

        moveSheetToIndex(sheet: spreadsheet.Sheet, index: number): void;

        refresh(): void;

        removeSheet(sheet: spreadsheet.Sheet): void;

        renameSheet(sheet: spreadsheet.Sheet, newSheetName: string): spreadsheet.Sheet;
    ...
    class Stepper extends Widget {
        ...
        insertAt(index: number, step: stepper.StepOptions): void;
        ...
        steps(steps: stepper.StepOptions[]): void;
    }
    ...
    interface StepperOptions {
        ...
        steps: stepper.StepOptions[] | string[];
    ...
    class TabStrip extends Widget {
        ...
        disable(element: string): TabStrip;

        disable(element: Element): TabStrip;

        disable(element: JQuery): TabStrip;

        enable(element: string, enable?: boolean): TabStrip;

        enable(element: Element, enable?: boolean): TabStrip;

        enable(element: JQuery, enable?: boolean): TabStrip;

        insertAfter(item: any, referenceTab: string): TabStrip;

        insertAfter(item: any, referenceTab: Element): TabStrip;

        insertAfter(item: any, referenceTab: JQuery): TabStrip;

        insertAfter(item: string, referenceTab: string): TabStrip;

        insertAfter(item: string, referenceTab: Element): TabStrip;

        insertAfter(item: string, referenceTab: JQuery): TabStrip;

        insertAfter(item: Element, referenceTab: string): TabStrip;

        insertAfter(item: Element, referenceTab: Element): TabStrip;

        insertAfter(item: Element, referenceTab: JQuery): TabStrip;

        insertAfter(item: JQuery, referenceTab: string): TabStrip;

        insertAfter(item: JQuery, referenceTab: Element): TabStrip;

        insertAfter(item: JQuery, referenceTab: JQuery): TabStrip;

        insertBefore(item: any, referenceTab: string): TabStrip;

        insertBefore(item: any, referenceTab: Element): TabStrip;

        insertBefore(item: any, referenceTab: JQuery): TabStrip;

        insertBefore(item: string, referenceTab: string): TabStrip;

        insertBefore(item: string, referenceTab: Element): TabStrip;

        insertBefore(item: string, referenceTab: JQuery): TabStrip;

        insertBefore(item: Element, referenceTab: string): TabStrip;

        insertBefore(item: Element, referenceTab: Element): TabStrip;

        insertBefore(item: Element, referenceTab: JQuery): TabStrip;

        insertBefore(item: JQuery, referenceTab: string): TabStrip;

        insertBefore(item: JQuery, referenceTab: Element): TabStrip;

        insertBefore(item: JQuery, referenceTab: JQuery): TabStrip;

        items(): HTMLCollection;

        reload(element: string): TabStrip;

        reload(element: Element): TabStrip;

        reload(element: JQuery): TabStrip;

        remove(element: string): TabStrip;

        remove(element: number): TabStrip;

        remove(element: JQuery): TabStrip;
    ...
    class TileLayout extends Widget {
    ...
    interface TouchTouchstartEvent extends TouchEvent {
        touch?: mobile.ui.TouchEventOptions;
        event?: JQueryEventObject;
    }
    ...
    class TreeList extends Widget {
        ...
        dataItem(row: string): data.TreeListModel;

        dataItem(row: Element): data.TreeListModel;

        dataItem(row: JQuery): data.TreeListModel;
        ...
        itemFor(model: data.TreeListModel): JQuery;
        ...
        setDataSource(dataSource: data.TreeListDataSource): void;
    ...
    interface TreeListOptions {
        ...
        dataSource?: any | any | data.TreeListDataSource;
    ...
    interface TreeListDragendEvent extends TreeListEvent {
        source?: data.TreeListModel;
        destination?: data.TreeListModel;
    }
    ...
    class TreeView extends Widget {
        ...
        expandTo(targetNode: data.Node): void;
...
declare namespace kendo.drawing {
    class Arc extends Element {
        ...
        constructor(geometry: geometry.Arc, options?: ArcOptions);
        ...
        clippedBBox(): geometry.Rect;

        containsPoint(point: geometry.Point): boolean;
        ...
        transform(transform: geometry.Transformation): void;
    ...
    class Circle extends Element {
        ...
        constructor(geometry: geometry.Circle, options?: CircleOptions);
    ...
    class LinearGradient extends Gradient {
        ...
        end(end: geometry.Point): void;

        start(): geometry.Point;

        start(start: any): void;

        start(start: geometry.Point): void;
    ...
    class MultiPath extends Element {
        ...
        curveTo(controlOut: any, controlIn: any, endPoint: geometry.Point): MultiPath;

        curveTo(controlOut: any, controlIn: geometry.Point, endPoint: any): MultiPath;

        curveTo(controlOut: any, controlIn: geometry.Point, endPoint: geometry.Point): MultiPath;

        curveTo(controlOut: geometry.Point, controlIn: any, endPoint: any): MultiPath;

        curveTo(controlOut: geometry.Point, controlIn: any, endPoint: geometry.Point): MultiPath;

        curveTo(controlOut: geometry.Point, controlIn: geometry.Point, endPoint: any): MultiPath;

        curveTo(controlOut: geometry.Point, controlIn: geometry.Point, endPoint: geometry.Point): MultiPath;
        ...
        lineTo(x: geometry.Point, y?: number): MultiPath;

        moveTo(x: number, y?: number): MultiPath;

        moveTo(x: any, y?: number): MultiPath;

        moveTo(x: geometry.Point, y?: number): MultiPath;
    ...
    class Path extends Element {
        ...
        static fromArc(arc: geometry.Arc, options?: any): Path;

        static fromPoints(points: any, options?: any): Path;

        static fromRect(rect: geometry.Rect, options?: any): Path;

        static parse(svgPath: string, options?: any): MultiPath;
        ...
        curveTo(controlOut: any, controlIn: any, endPoint: geometry.Point): Path;

        curveTo(controlOut: any, controlIn: geometry.Point, endPoint: any): Path;

        curveTo(controlOut: any, controlIn: geometry.Point, endPoint: geometry.Point): Path;

        curveTo(controlOut: geometry.Point, controlIn: any, endPoint: any): Path;

        curveTo(controlOut: geometry.Point, controlIn: any, endPoint: geometry.Point): Path;

        curveTo(controlOut: geometry.Point, controlIn: geometry.Point, endPoint: any): Path;

        curveTo(controlOut: geometry.Point, controlIn: geometry.Point, endPoint: geometry.Point): Path;
        ...
        lineTo(x: geometry.Point, y?: number): Path;

        moveTo(x: number, y?: number): Path;

        moveTo(x: any, y?: number): Path;

        moveTo(x: geometry.Point, y?: number): Path;
    ...
    class RadialGradient extends Gradient {
        ...
        center(center: geometry.Point): void;
    ...
    class Rect extends Element {
        ...
        constructor(geometry: geometry.Rect, options?: RectOptions);
    ...
    class Segment extends Class {
        ...
        constructor(anchor: geometry.Point, controlIn: geometry.Point, controlOut: geometry.Point);


        anchor(): geometry.Point;

        anchor(value: geometry.Point): void;

        controlIn(): geometry.Point;

        controlIn(value: geometry.Point): void;

        controlOut(): geometry.Point;

        controlOut(value: geometry.Point): void;
    ...
    class Surface extends Observable {
        ...
        static create(element: JQuery, options?: any): Surface;

        static create(element: Element, options?: any): Surface;
        ...
        showTooltip(element: Element, options?: any): void;
    ...
    class Text extends Element {
        ...
        constructor(content: string, position: geometry.Point, options?: TextOptions);
        ...
        position(value: geometry.Point): void;
...
declare namespace kendo.dataviz.ui {
    ...
    class Chart extends kendo.ui.Widget {
        ...
        findPaneByIndex(index: number): dataviz.ChartPane;

        findPaneByName(name: string): dataviz.ChartPane;

        findSeries(callback: Function): ChartSeries;

        findSeriesByIndex(index: number): ChartSeries;

        findSeriesByName(name: string): ChartSeries;

        getAxis(name: string): ChartAxis;

        hideTooltip(): void;

        plotArea(): dataviz.ChartPlotArea;
    ...
    class Diagram extends kendo.ui.Widget {
        ...
        connectionsDataSource: data.DataSource;
        shapes: diagram.Shape[];
        ...
        addShape(obj: any, undoable: boolean): diagram.Shape;

        alignShapes(direction: string): void;

        boundingBox(items: any): diagram.Rect;
        ...
        getConnectionByModelId(id: string): diagram.Connection;

        getConnectionByModelId(id: number): diagram.Connection;

        getConnectionByModelUid(uid: string): diagram.Connection;

        getShapeById(id: string): any;

        getShapeByModelId(id: string): diagram.Shape;

        getShapeByModelId(id: number): diagram.Shape;

        getShapeByModelUid(uid: string): diagram.Shape;
        ...
        select(elements: diagram.Connection, options: any): void;

        select(elements: diagram.Shape, options: any): void;

        select(elements: any, options: any): void;

        selectAll(): void;

        selectArea(rect: diagram.Rect): void;

        setConnectionsDataSource(dataSource: data.DataSource): void;
        ...
        viewToDocument(point: diagram.Point): diagram.Point;

        viewToModel(point: diagram.Point): diagram.Point;

        viewport(): diagram.Rect;

        zoom(): number;

        zoom(zoom: number, point: diagram.Point): void;
    ...
    interface DiagramOptions {
        ...
        connectionsDataSource?: any | any | data.DataSource;
        dataSource?: any | any | data.DataSource;
    ...
    class Map extends kendo.ui.Widget {
        ...
        center(center: map.Location): void;
        ...
        extent(extent: map.Extent): void;

        layerToLocation(point: any, zoom: number): map.Location;

        layerToLocation(point: kendo.geometry.Point, zoom: number): map.Location;

        locationToLayer(location: any, zoom: number): kendo.geometry.Point;

        locationToLayer(location: map.Location, zoom: number): kendo.geometry.Point;

        locationToView(location: any): kendo.geometry.Point;

        locationToView(location: map.Location): kendo.geometry.Point;
        ...
        viewToLocation(point: any, zoom: number): map.Location;

        viewToLocation(point: kendo.geometry.Point, zoom: number): map.Location;
...
declare namespace kendo.dataviz.map {
    class BingLayer extends TileLayer {
        ...
        constructor(map: dataviz.ui.Map, options?: BingLayerOptions);
    ...
    class Extent extends Class {
        ...
        constructor(nw: Location | any, se: Location | any);

        static create(a: Location, b?: Location): Extent;

        static create(a: Location, b?: any): Extent;

        static create(a: any, b?: Location): Extent;

        static create(a: any, b?: any): Extent;
    ...
    class Layer extends Class {
        ...
        constructor(map: dataviz.ui.Map, options?: LayerOptions);
    ...
    class Location extends Class {
        ...
        static create(lat: any, lng?: number): Location;

        static create(lat: Location, lng?: number): Location;

        static fromLngLat(lnglat: any): Location;

        static fromLatLng(lnglat: any): Location;

        clone(): Location;

        destination(destination: Location, bearing: number): number;

        distanceTo(distance: number, bearing: number): Location;
    ...
    class MarkerLayer extends Layer {
        ...
        constructor(map: dataviz.ui.Map, options?: MarkerLayerOptions);
    ...
    class ShapeLayer extends Layer {
        ...
        constructor(map: dataviz.ui.Map, options?: ShapeLayerOptions);
    ...
    class TileLayer extends Layer {
        ...
        constructor(map: dataviz.ui.Map, options?: TileLayerOptions);
...
declare namespace kendo.dataviz {
    ...
    class ChartSeries extends Observable {
        ...
        findPoint(callback: Function): ChartPoint;
...
declare namespace kendo.dataviz.diagram {
    ...
    class Connection extends Observable {
        ...
        constructor(from?: Shape, to?: Shape, options?: ConnectionOptions);


        source(): any;

        source(source: Shape): void;

        source(source: Point): void;

        source(source: Connector): void;

        sourcePoint(): Point;

        target(): any;

        target(target: Shape): void;

        target(target: Point): void;

        target(target: Connector): void;
    ...
    class Layout extends Observable {
        ...
        constructor(rect: Rect, options?: LayoutOptions);
...
declare namespace kendo {
    ...
    namespace drawing {
        function align(elements: any, rect: geometry.Rect, alignment: string): void;

        function drawDOM(element: JQuery, options: any): JQueryPromise<any>;

        function exportImage(group: Group, options?: any): JQueryPromise<any>;

        function exportPDF(group: Group, options?: PDFOptions): JQueryPromise<any>;

        function exportSVG(group: Group, options?: any): JQueryPromise<any>;

        function fit(element: Element, rect: geometry.Rect): void;

        function stack(elements: any): void;

        function vAlign(elements: any, rect: geometry.Rect, alignment: string): void;

        function vStack(elements: any): void;

        function vWrap(elements: any, rect: geometry.Rect): any;

        function wrap(elements: any, rect: geometry.Rect): any;
    }
    ...
    function bind(element: string, viewModel: data.ObservableObject, namespace?: any): void;

    function bind(element: JQuery, viewModel: any, namespace?: any): void;

    function bind(element: JQuery, viewModel: data.ObservableObject, namespace?: any): void;

    function bind(element: Element, viewModel: any, namespace?: any): void;

    function bind(element: Element, viewModel: data.ObservableObject, namespace?: any): void;
    ...
    function parseColor(color: string, noerror: boolean): Color;

    function prompt(text: string, defaultValue: string): JQueryPromise<any>;

    function proxyModelSetters(): void;

    function proxyModelSetters(data: data.Model): void;
...
declare namespace kendo.spreadsheet {
    ...
    class Sheet extends Observable {
        ...
        range(rowIndex: number, columnIndex: number, rowCount?: number, columnCount?: number): Range;
        ...
        setDataSource(dataSource: data.DataSource, columns?: any): void;
...
declare namespace kendo.mobile.ui {
    ...
    class ListView extends Widget {
        ...
        setDataItem(item: JQuery, dataItem: data.Model): void;
    ...
    class SplitView extends Widget {
...
declare namespace kendo.dataviz.drawing {
    ...
    class MultiPath extends kendo.drawing.Element {
        ...
        curveTo(controlOut: any, controlIn: kendo.geometry.Point, endPoint: kendo.geometry.Point): kendo.drawing.
            MultiPath;

        curveTo(controlOut: kendo.geometry.Point, controlIn: any, endPoint: any): kendo.drawing.MultiPath;

        curveTo(controlOut: kendo.geometry.Point, controlIn: any, endPoint: kendo.geometry.Point): kendo.drawing.
            MultiPath;

        curveTo(controlOut: kendo.geometry.Point, controlIn: kendo.geometry.Point, endPoint: any): kendo.drawing.
            MultiPath;

        curveTo(controlOut: kendo.geometry.Point, controlIn: kendo.geometry.Point, endPoint: kendo.geometry.Point):
