namespace Inspire.Portal.Controllers
{
    ...
    {
        public static readonly string VirtualPath = Path.Combine(ConfigurationReader.AttachmentsVirtualPath, PrettyName);
        private const string PrettyName = "Files/";

        private readonly IStorageService storageService;

        public FileBrowserController(IStorageService storageService)
        {
